 ...
 * element interface generated in the com.offcn package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _GetValue_QNAME = new QName("http://offcn.com/", "getValue");
	private final static QName _GetValueResponse_QNAME = new QName("http://offcn.com/", "getValueResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: com.offcn
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://offcn.com/", name = "getValue")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://offcn.com/", name = "getValueResponse")
